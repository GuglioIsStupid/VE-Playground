...
return {
	...
	initUI = function(self)
		...
		if song == 3 then
			weeksRN:generateNotes(love.filesystem.load("songs/week4/milf/" .. difficulty .. ".lua")())
		elseif song == 2 then
			weeksRN:generateNotes(love.filesystem.load("songs/week4/high/" .. difficulty .. ".lua")())
		else
			weeksRN:generateNotes(love.filesystem.load("songs/week4/satin-panties/" .. difficulty .. ".lua")())
		end
	end,
	...
	draw = function(self)
		love.graphics.push()
			...
			weeksRN:drawRating(1)
			
		love.graphics.pop()
		weeksRN:drawHealthBar()
		if not paused then
			weeksRN:drawUI()
		end
	end,
