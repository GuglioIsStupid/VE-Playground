	...
	generateNotes = function(self, chart)
        ...
        for i = 1, #chart do
            ...
            for j = 1, #chart[i].sectionnotes do
                ...
                local mustHitSection = chart[i].sectionnotes[j].mustHitSection
                local altAnim = chart[i].sectionnotes[j].altAnim
                local noteType = chart[i].sectionnotes[j].noteType
                local noteTime = chart[i].sectionnotes[j].noteLength
                ...
                if mustHitSection then
                    if noteType >= 4 then
                        ...
                        if noteVersion[1] == noteVersion[2] then table.insert(enemyNotes[id], sprite())
                        else table.insert(enemyNotes[id], sprite()); table.insert(enemyNotes2[id], sprite()) end
                        enemyNotes[id][c].x = x
