...
return {
	...
	initUI = function(self)
		...
		for i = 1, 4 do
			enemyArrows[i].x = -975 + 150 * 4 + 150 * i
            enemy2Arrows[i].x = -975 + 150 * i
			boyfriendArrows[i].x = 225 + 150 * i 
			leftArrowSplash.x = 225 + 150 * 1 + 5
			downArrowSplash.x = 225 + 150 * 2 + 5
			upArrowSplash.x =  225 + 150 * 3 + 5
			rightArrowSplash.x = 225 + 150 * 4 + 5

			enemyArrows[i].y = -400
			boyfriendArrows[i].y = -400
            enemy2Arrows[i].y = -400
		...
		if not paused then
			if not doingDialogue then
				...
				for i = 1, 4 do
                    ...
                    local enemy2Arrow = enemy2Arrows[i]
                    ...
                    enemy2Arrow:update(dt)

					if not enemyArrow:isAnimated() then
						enemyArrow:animate("off", false)
					end
                    if not enemy2Arrow:isAnimated() then
                        enemy2Arrow:animate("off", false)
                    end
					if settings.botPlay then
                    ...
                    if #enemy2Note > 0 then
                        if (enemy2Note[1].y - musicPos <= -400) then
                            ...
                            enemy2Arrow:animate("confirm", false)
				...
				love.graphics.push()
                    ...
                    for j = #enemy2Notes[i], 1, -1 do
						if (enemy2Notes[i][j].y - musicPos <= 560) then
							...
							enemy2Notes[i][j]:udraw(1, enemy2Notes[i][j].sizeY)
							graphics.setColor(1, 1, 1)
						end
					end
